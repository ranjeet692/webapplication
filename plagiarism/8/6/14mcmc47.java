...
class assign
{
void assign(String B)
{int flag=0;
        for (char r: B.toCharArray())
       {
       if(r==' ')
       flag=1;
        }
...
void  assign(String s3, String s4, String s5)
{
...
void assign(String s6,String s7,String s8,String s9)
{
